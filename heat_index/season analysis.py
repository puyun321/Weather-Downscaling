...
def seasonal_performance(forecast_timestep):
    ...
    for season_index in range(len(season)):
        ...
        temp_ranges = [27, 32, 41, 54, 60]  # Including a value beyond 54 for gradient to red
        colors = ["#FFFF00", "#FFD700", "#FF8C00", "#FF0000"]  # Yellow, gold, dark orange, red
        cmap = mcolors.LinearSegmentedColormap.from_list("custom_cmap", colors, N=256)
        norm = mcolors.Normalize(vmin=temp_ranges[0], vmax=temp_ranges[-1])
        min_val=temp_ranges[0]; max_val=temp_ranges[-1]
