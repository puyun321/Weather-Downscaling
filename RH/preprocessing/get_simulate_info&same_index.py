...
skip_regionname="信義區"
zhuoshui_weather_info=pd.read_excel(r"D:\lab\research\weather downscale\dataset\濁水溪\T.xlsx",sheet_name="date_info",index_col=0).iloc[:,:3]
zhuoshui_weather_info.columns=["col0","col1","col2"]

zhuoshui_prep_info=pd.read_excel(r"D:\lab\research\weather downscale\dataset\濁水溪\Prep.xlsx",sheet_name="date_info",index_col=0).iloc[:,:3]
...
writer = pd.ExcelWriter('D:/lab/research/weather downscale/dataset/濁水溪/same_index.xlsx', engine='xlsxwriter')
...
simulate_info.to_csv(r"D:\lab\research\weather downscale\info\simulate_zhuoshui_info.csv",encoding="big5")

#%% get unique date index from date
weather_index_=pd.read_excel(r'D:/lab/research/weather downscale/dataset/濁水溪/same_index.xlsx',sheet_name="weather_index")
all_station_info=pd.read_csv(r"D:\lab\research\weather downscale\info\selected_zhuoshui_info2.csv",index_col=0,encoding="big5")
all_station_info=all_station_info.iloc[weather_index_.iloc[:,0],:].reset_index(drop=True)

station_info=pd.read_csv(r"D:\lab\research\weather downscale\info\selected_zhuoshui_info3.csv",index_col=0,encoding="big5")
...
unique_index.to_csv(r"D:\lab\research\weather downscale\dataset\濁水溪\unique_index.csv")
...
unique_date_index.to_csv(r"D:\lab\research\weather downscale\dataset\濁水溪\unique_date_index.csv")
