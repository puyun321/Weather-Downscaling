...
#%% read code dataset
train_code1=pd.read_excel("code_dataset/RH/encoded_value.xlsx",sheet_name="train_code_y(obs)",index_col=0)
train_code2=pd.read_excel("code_dataset/RH/encoded_value.xlsx",sheet_name="train_code_y(simulate)",index_col=0)
test_code1=pd.read_excel("code_dataset/RH/encoded_value.xlsx",sheet_name="test_code_y(obs)",index_col=0)
test_code2=pd.read_excel("code_dataset/RH/encoded_value.xlsx",sheet_name="test_code_y(simulate)",index_col=0)
code_1=np.array(pd.concat([train_code1,test_code1])); code_2=np.array(pd.concat([train_code2,test_code2]))
code_3=np.array(pd.read_excel("code_dataset/RH/encoded_value(T-1-T-5).xlsx",sheet_name="obs_T1_code",index_col=0))
code_4=np.array(pd.read_excel("code_dataset/RH/encoded_value(T-1-T-5).xlsx",sheet_name="obs_T2_code",index_col=0))
code_5=np.array(pd.read_excel("code_dataset/RH/encoded_value(T-1-T-5).xlsx",sheet_name="obs_T3_code",index_col=0))
code_6=np.array(pd.read_excel("code_dataset/RH/encoded_value(T-1-T-5).xlsx",sheet_name="obs_T4_code",index_col=0))
code_7=np.array(pd.read_excel("code_dataset/RH/encoded_value(T-1-T-5).xlsx",sheet_name="obs_T5_code",index_col=0))
...
epochs = 50
batch_size = 64
lstm_hidden_layer = 1 # see tuner result
...
# 訓練模式
checkpoint = ModelCheckpoint("RH/model/"+ model_name+ ".keras", save_best_only = True)
...
writer = pd.ExcelWriter(r'RH\result\performance_%s.xlsx'%(model_name.split(".")[0]),engine='xlsxwriter')
#save performance
